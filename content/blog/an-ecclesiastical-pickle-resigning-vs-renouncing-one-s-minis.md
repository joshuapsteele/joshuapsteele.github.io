...
Put differently, the argument is that the phrase "resignation or renunciation of the [ordained] ministry," which occurs four times in the Canons **does not describe two different ways of leaving ministry, but the one way of leaving ministry**.
...
If resigning and renouncing are one and the same, then my options are:

1. Stay connected to a bishop in the ACNA,
2. Ask to transfer my ordination elsewhere, or
